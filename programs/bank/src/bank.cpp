...
bool Bank::init(const char* db_path, const char* acc_tbl){
 ...
 std::string sql="CREATE TABLE '"+DB::sql_str(acc_tbl)+"' (id INTEGER PRIMARY KEY, email text NOT NULL, hash text NOT NULL,balance, date_created DATE CURRENT_DATE);";
